...
void OnTick(){R10RecoveryUpdateState();Rule9DetectActivatedOrders();BuyMachine();SellMachine();CreateFirstOrdersIfFlat();TrailAllStopOrders();UpdateExposureTelemetry();EAGOLD_ModPanelUpdate();EAGOLD_ChartBasketGuidesUpdate();PersistAllState();}
