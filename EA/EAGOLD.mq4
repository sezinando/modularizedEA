...
void OnTick(){R10RecoveryUpdateState();Rule9DetectActivatedOrders();BuyMachine();SellMachine();CreateFirstOrdersIfFlat();TrailAllStopOrders();R13Observe(g_r13Observer);UpdateExposureTelemetry();EAGOLD_ModPanelUpdate();EAGOLD_ChartBasketGuidesUpdate();PersistAllState();}
